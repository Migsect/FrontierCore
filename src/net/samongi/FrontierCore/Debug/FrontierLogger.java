package net.samongi.FrontierCore.Debug;
...
{ 
  ...
  public FrontierLogger(Logger logger)
  {
    this.logger = logger;
  }
  ...
  public void parseConfiguration(ConfigurationSection section)
  {
    ...
    this.setAlwaysShow(section.getBoolean("always_show", true));
